...
- Bootstrap config precedence is CLI > environment > TOML > defaults. Default file: OS user config directory `puqu-ipp/config.toml`; both listeners bind exactly as configured.
