...
func (s *Server) getPrinterAttributes(ctx context.Context, request *goipp.Message, host string) *goipp.Message {
	...
	attrs.Add(goipp.MakeAttr("printer-info", goipp.TagText, goipp.String("PUQU AQ20 USB label printer")))
	attrs.Add(goipp.MakeAttr("printer-location", goipp.TagText, goipp.String("Local USB bridge")))
