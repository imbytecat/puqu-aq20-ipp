...
func (s *Server) getPrinterAttributes(ctx context.Context, request *goipp.Message, host string) *goipp.Message {
	...
	formats := []goipp.Value{goipp.String(raster.FormatPWG)}
	...
	attrs.Add(goipp.MakeAttr("printer-device-id", goipp.TagText, goipp.String("MFG:PUQU;MDL:AQ20;CMD:PWGRaster,AppleRaster;")))
	...
	attrs.Add(goipp.MakeAttr("multiple-document-jobs-supported", goipp.TagBoolean, goipp.Boolean(true)))
	attrs.Add(goipp.MakeAttr("multiple-document-handling-default", goipp.TagKeyword, goipp.String("separate-documents-collated-copies")))
	attrs.Add(goipp.MakeAttr("multiple-document-handling-supported", goipp.TagKeyword, goipp.String("separate-documents-collated-copies")))
	...
	attrs.Add(goipp.MakeAttr("media-col-supported", goipp.TagKeyword,
		goipp.String("media-size"), goipp.String("media-size-name"), goipp.String("media-left-margin"),
		goipp.String("media-right-margin"), goipp.String("media-top-margin"), goipp.String("media-bottom-margin")))
	...
	if settings.Airprint == 1 {
		attrs.Add(goipp.MakeAttr("urf-supported", goipp.TagKeyword, goipp.String("W8,SRGB24,RS203,DM1")))
	}
	return reply
}
