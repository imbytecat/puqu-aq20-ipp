...
func (p *Printer) Busy() bool          { return p.busy.Load() }
func (p *Printer) Disconnect() error   { return p.link.Disconnect() }
func (p *Printer) Cancel() error       { return p.link.Write(puqu.Cancel()) }
